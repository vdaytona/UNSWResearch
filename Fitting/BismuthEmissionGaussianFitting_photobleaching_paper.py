...
def r_square_score(target,fitted):
    ...
    score3 = r2_score(target3, fitted3) * 14 / 105
    score4 = r2_score(target4, fitted4) * 10 / 105
    score5 = r2_score(target5, fitted5) * 6 / 105
...
def fit_one_spectrum(xData, yData):
    ...
    center_wavelength = [950,1091,1250,1426,1535]
